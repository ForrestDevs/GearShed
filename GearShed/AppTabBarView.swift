...
struct AppTabBarView: View {
    ...
    var body: some View {
        ...
        TabView(selection: $currentTab) {
            ...
            NavigationView { GearShedView(bottomEdge: bottomEdge, persistentStore: persistentStore) }
                .frame(maxWidth: .infinity ,maxHeight: .infinity)
                .tag("GearShed")
            
            NavigationView { GearlistView(bottomEdge: bottomEdge, persistentStore: persistentStore) }
                .frame(maxWidth: .infinity ,maxHeight: .infinity)
                .tag("Gearlist")
