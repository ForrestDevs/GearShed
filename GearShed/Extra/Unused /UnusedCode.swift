...
struct CustomTabBar: View {
 ...
 // Initialize the pdf page bounds to standard page size
 init(pageRect: CGRect = CGRect(x: 0, y: 0, width: (8.5 * 72.0), height: (11 * 72.0))) {
    
     let metaData = [
         kCGPDFContextTitle: "GearShed PDF",
         kCGPDFContextAuthor: "Luke Gannon",
         kCGPDFContextCreator: "GearShed",
       ]
 ...
 private func addWaterMarkAtBottom() {
